...
HD_PWD='/home/zhangshuai/develop/soft_core/vivado_project/zynq_aximem/test_zynq_aximem_ip/zynq_axi_mem_ip/zynq_axi_mem_ip.runs/design_1_s_axi_lite_mem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s_axi_lite_mem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s_axi_lite_mem_0_0.tcl
