...
HD_PWD='/home/zhangshuai/develop/pico_vivado/src/mem_test_mpu/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log picosoc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source picosoc.tcl -notrace
