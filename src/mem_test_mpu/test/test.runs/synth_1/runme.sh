...
HD_PWD='/home/zhangshuai/develop/pico_vivado/src/mem_test_mpu/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picosoc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picosoc.tcl
